...
io.outputs = ib_levelset ib_normal ib_src_term

incflo.velocity = 30.0 0.0 0.0
incflo.use_godunov = 1
incflo.godunov_type = "weno_z"
incflo.do_initial_proj = 1
incflo.initial_iterations = 3
ICNS.source_terms = IBForcing #BodyForce
...
#amr.n_cell     = 64 8 128   # Grid cells at coarsest AMRlevel
...
geometry.prob_hi        =   0.32  0.04 0.32  
geometry.is_periodic    =   0   1   0   # Periodicity x y z (0/1)

# Boundary conditions
xlo.type = "mass_inflow"
#xlo.type = "pressure_inflow"
#xlo.velocity.type = "fixed_gradient"
xlo.density = 1.0

xlo.velocity = 30.0 0.0 0.0
