...
set(CTEST_BUILD_NAME "Kynema-SGF-${CMAKE_SYSTEM_NAME}${EXTRA_BUILD_NAME}")
...
set(CTEST_CONFIGURE_COMMAND "cmake ${CMAKE_CONFIGURE_ARGS} -DKYNEMA_SGF_ENABLE_TESTS:BOOL=ON ${CTEST_SOURCE_DIRECTORY}")
