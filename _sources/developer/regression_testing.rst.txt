...
Kynema-SGF comes with a suite of regression tests to ensure that the relevant
...
version of Kynema-SGF, build and run the executable once to generate the gold
...
:file:`kynema-sgf/tests/test_files` and are arranged in directories corresponding
...
test definitions are added to :file:`kynema-sgf/tests/CTestList.cmake`.
